...
const Home = () => {
  ...
  const renderPopularCompetitions = () => {
    const popularCompetitions = competitionList.filter(item => item.popular) || [];
    return popularCompetitions.map(competition => (<Competition key={ genRowKey('popular_competition_') } data={ competition } />))
  };

  const renderFeaturedCompetitions = () => {
    const featuredCompetitions = competitionList.filter(item => item.popular) || [];
  ...
  const renderGeneralStatus = () => {
    return generalStatus.map(({ label, count }) => {
      return (
        <div key={ genRowKey('general_status') } class="column">
  ...
  return (
    <div>
      <div id="header" className="ui inverted vertical center aligned segment masthead">
        <div id="bg"></div>
        <div className="ui container">
          <div id="topleft_menu" className="ui secondary inverted menu">
            <span className="left item">
              <a href="/" id="home-logo">
                <img className="ui mini image" src="/static/img/Cha_Logo.png" />
              </a>
              <Search />
            </span>
            ...
            <div class="ui middle stackable grid container">
              <div class="eight wide left aligned column">
                <div class="row column-bottom-padding">
                  <h3 class="ui color-header header">What is CodaBench?</h3>
                ...
                <div class="row column-bottom-padding">
                  <h3 class="ui color-header header">What is Codalab?</h3>
                  <div class="ui divider"></div>
                ...
                <div class="row column-bottom-padding">
                  <h3 class="ui color-header header">History of Codalab</h3>
                  <div class="ui divider"></div>
                  ...
                  <p>Some competitions have been organized using worksheets, but the competition platform
                    ...
                    2014,
                    <a class="large_links" href="http://www.chalearn.org/">ChaLearn</a> joined to co-develop
                    Codalab
                    competitions. Since
                    2015, University Paris-Saclay is
                    community lead of Codalab competitions, under the direction of Isabelle Guyon, professor
                    of big
                    data. Codalab is administered by CKCollab and the <a class="large_links" href="https://www.lri.fr/">LRI
                      staff.</a>
                  </p>
                </div>

                <div class="row column-bottom-padding">
                  <h3 class="ui color-header header">Codalab in Research</h3>
                  <div class="ui divider"></div>
                  <p>Codalab is used actively in research. In
                    ...
                    profile challenges include the <a class="large_links" href="https://web.see4c.eu/">2
                      million Euro prize of the EU, organized by the See.4C
                      consortium</a>, the <a class="large_links" href="https://competitions.codalab.org/competitions/16652">CIKM
